...
class _ApiService implements ApiService {
  ...
  Future<OrdersResponseModel> getOrders(
    ...
    final _options = _setStreamType<OrdersResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<OrdersDetailsResponseModel> orderDetails(String orderId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OrdersDetailsResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<StatisticsResponseModel> getStatistics() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<StatisticsResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
