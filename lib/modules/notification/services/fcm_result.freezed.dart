...
/// @nodoc
abstract class $FcmResultCopyWith<T, $Res> {
  factory $FcmResultCopyWith(
          FcmResult<T> value, $Res Function(FcmResult<T>) then) =
      _$FcmResultCopyWithImpl<T, $Res, FcmResult<T>>;
}

/// @nodoc
class _$FcmResultCopyWithImpl<T, $Res, $Val extends FcmResult<T>>
    implements $FcmResultCopyWith<T, $Res> {
  _$FcmResultCopyWithImpl(this._value, this._then);
...
class __$$SucessImplCopyWithImpl<T, $Res>
    extends _$FcmResultCopyWithImpl<T, $Res, _$SucessImpl<T>>
...
class _$SucessImpl<T> implements Sucess<T> {
  ...
  @override
  String toString() {
    return 'FcmResult<$T>.success(data: $data)';
  }
...
abstract class Sucess<T> implements FcmResult<T> {
...
class __$$FailureImplCopyWithImpl<T, $Res>
    extends _$FcmResultCopyWithImpl<T, $Res, _$FailureImpl<T>>
...
class _$FailureImpl<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'FcmResult<$T>.failure(e: $e)';
  }
...
abstract class Failure<T> implements FcmResult<T> {
